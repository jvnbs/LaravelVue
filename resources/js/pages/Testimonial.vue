...
<section class="page-title-section" style="background-image: url(https://www-demo.basket.qa/public/frontend/img/faq-header-img.png); background-size: cover; background-position: center; padding: 80px 0; color: #fff;">
    <div class="container text-center">
               <h1 class="page-title text-primary h2 font-weight-bold">Accusantium adipisci aut omnis laudantium odio cu</h1>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center bg-transparent p-0">
                    ...
                    <li class="breadcrumb-item active text-dark" aria-current="page">Accusantium adipisci aut omnis laudantium odio cu</li>
                </ol>
            </nav>
        </div>
    </div>
