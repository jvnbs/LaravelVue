      ...
      <div class="row">
        <div class="col-md-12">
          <div class="ticket_info_top">
            <router-link to="/tickets" class="ticket_back"> Back </router-link>
          ...
          <div class="ticket_info_left">
            ...
            <div class="ticket_info_box">
              <div class="ticket_info_box_txt">
                <h6>Tracking ID</h6>
                <p class="cur_ticket_id">#{{ ticket.id }}</p>
              </div>
              <div class="ticket_info_box_txt">
                <h6>Date</h6>
              ...
              <div class="ticket_info_box_txt">
                ...
                <p class="cur_ticket_status">
                  Open
                  <!-- Replace if status exists -->
                </p>
              </div>
              <div class="ticket_info_box_txt">
                <h6>Last update</h6>
                <p class="cur_ticket_update">22-01-2025 <span>3:50 PM</span></p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="ticket_info_right">
              <div class="ticket_info_right_top">
                <div class="left_avtar">
                  <div class="left_avtar_head user_name_alpha">AS</div>
                </div>
                <div class="avtar_title user_name">Abhishek Saini</div>
                <div class="dots_avtar">.</div>
                <div class="avtar_time">
                  <div class="avtar_time_left">
                    <span>12:03 PM</span>
                  </div>
                  <div class="avtar_time_response">(responded in 1 day)</div>
                </div>
              </div>
          ...
          <div class="ticket_reply_form">
            <form id="ticket_chat_submit" method="post">
              <input
                type="hidden"
                name="support_id"
                class="ticket_chats_support_id"
                value=""
              />
              <input
                type="hidden"
                name="user_id"
                class="ticket_chats_user_id"
                value="0"
              />
              ...
              <div class="reply_form_footer">
                ...
                <div class="reply_form_footer_right">
                  <button class="btn_reply_send" id="sendReply">Send</button>
                </div>
              </div>
