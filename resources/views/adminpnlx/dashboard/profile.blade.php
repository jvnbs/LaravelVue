    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('Admin.profileUpdate') }}" method="Post" id="mw-form">
                        @csrf()
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $modelDetail->email) }}" placeholder="Enter Email" readonly />
                                    @error('email')
                                        <small class="text-danger text-bold">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <figure class="imagecheck" style="width:100px; margin-top:5px;">
                                        <img class="w-100" src="{{asset('img/examples/product1.jpg')}}" alt="title"
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="editor" rows="5" maxLength="250">{{ old('description', $modelDetail->description)}}</textarea>
                                </div>
                            </div>
