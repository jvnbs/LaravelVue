                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                        <li>
                            <div class="user-box">
                                ...
                                <div class="u-text">
                                    <h4>{{ getAuthName() }}</h4>
                                    <p class="text-muted">{{ getAuthEmail() }}</p>
                                    <a href="/" target="_blank" class="btn btn-xs btn-secondary btn-sm">View Website</a>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <a class="dropdown-item" href="{{ Route('Admin.profile') }}">Inbox</a>
                            <div class="dropdown-divider"></div>
