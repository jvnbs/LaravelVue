                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">{{ $result->first_name ?? '' }} {{ $result->last_name ?? '' }}
                                    </td>
                                    ...
                                    <a href="{{ route($modelName . '.changeStatus', [base64_encode($result->id), 0]) }}" class="btn btn-icon btn-round btn-success btn-sm" title="Activated">
                                        ...
                                        <a href="{{ route($modelName . '.show', base64_encode($result->id)) }}" class="btn btn-icon btn-round btn-primary btn-sm me-2" title="View">
                                            <i class="fa fa-eye btn-sm"></i>
                                        </a>

                                        <a href="{{ route($modelName . '.edit', base64_encode($result->id)) }}" class="btn btn-icon btn-round btn-warning btn-sm me-2" title="Edit">
