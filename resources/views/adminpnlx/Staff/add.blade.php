                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstname"
                                        ...
                                        value="{{ old('firstname') }}" placeholder="Enter First Name" maxLength="32" />
                                    @error('firstname')
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lastname"
                                        ...
                                        value="{{ old('lastname') }}" placeholder="Enter Last Name" maxLength="32" />
                                    @error('lastname')
                                    <small class="text-danger text-bold">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    @foreach ($admin_modules as $admin_module)
                                        ...
                                        <?php $admin_module_actions = $admin_module->admin_module_actions; ?>
                                        <div class="card shadow-sm mb-3">
                                            <!-- Parent Module with  -->
                                            @if($admin_sub_modules->isNotEmpty() || $admin_module_actions->isNotEmpty())
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if($admin_sub_modules->isNotEmpty())
                                                    ...
                                                    @if($admin_sub_module_actions->isNotEmpty())
